...
export const Card: React.FC<Props> = ({ titulo, descricao, btn, downloadLink, onClick, link }) => {
  return (
    <article className="border-2 h-[20em]  rounded-xl shadow-xl shadow-[#00000065] px-6 py-3 transition text-center duration-300 hover:scale-105 max-w-[25em] border-none w-full">
