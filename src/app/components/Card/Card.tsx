...
export const Card: React.FC<Props> = ({ titulo, descricao, btn, downloadLink, onClick, link }) => {
  return (
    <article className="border-2  rounded-xl shadow-[5px_5px_5px_#000000] px-6 py-3 transition text-center duration-300 hover:scale-105 max-w-[25em] border-none h-[20em]">
